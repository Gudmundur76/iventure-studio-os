...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/os/meta-agent">
        <IVLayout><MetaAgent /></IVLayout>
      </Route>
      ...
      <Route path="/os/ai-router">
        <IVLayout><AIRouter /></IVLayout>
      </Route>
      <Route path="/os/leads">
        <IVLayout><Leads /></IVLayout>
      </Route>
      <Route path="/os/orders">
        <IVLayout><Orders /></IVLayout>
      </Route>
      <Route path="/service-portal/:portalToken">
        <ServicePortal />
      </Route>
